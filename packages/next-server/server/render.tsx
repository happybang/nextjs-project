...
export async function xhrConstruct (req: IncomingMessage, res: ServerResponse, pathname: string, query: ParsedUrlQuery, renderOpts: RenderOpts): Promise<string|null> {
  const {
    err,
    dev = false,
    staticMarkup = false,
