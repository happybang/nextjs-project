import Server from 'inext-server/dist/server/next-server'
import { join } from 'path'
import HotReloader from './hot-reloader'
import {route} from 'inext-server/dist/server/router'
import {PHASE_DEVELOPMENT_SERVER} from 'inext-server/constants'
