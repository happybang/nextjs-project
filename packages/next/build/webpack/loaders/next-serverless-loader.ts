...
import { BUILD_MANIFEST, REACT_LOADABLE_MANIFEST } from 'inext-server/constants'
...
const nextServerlessLoader: loader.Loader = function () {
  ...
  return `
    ...
    import {renderToHTML} from 'inext-server/dist/server/render';
    import {sendHTML} from 'inext-server/dist/server/send-html';
